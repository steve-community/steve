...
import de.rwth.idsg.steve.ocpp.ws.data.security.ExtendedTriggerMessageRequest;
import de.rwth.idsg.steve.ocpp.ws.data.security.ExtendedTriggerMessageResponse;
...
public class ExtendedTriggerMessageTask extends Ocpp16AndAboveTask<ExtendedTriggerMessageParams, String> {
    ...
    public ExtendedTriggerMessageRequest getOcpp16Request() {
        ExtendedTriggerMessageRequest request = new ExtendedTriggerMessageRequest();
    ...
    public AsyncHandler<ExtendedTriggerMessageResponse> getOcpp16Handler(String chargeBoxId) {
        return res -> {
            try {
                ExtendedTriggerMessageResponse response = res.get();
