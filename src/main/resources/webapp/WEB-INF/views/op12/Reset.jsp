...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.2/Reset">Reset</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.2/Reset" modelAttribute="params">
