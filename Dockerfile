...
RUN apt-get update && apt-get install -y unzip curl iproute2 traceroute netcat-traditional telnetd nmap net-tools dnsutils iputils-ping ca-certificates ca-certificates-java && \
