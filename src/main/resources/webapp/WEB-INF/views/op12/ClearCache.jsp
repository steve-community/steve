...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.2/ClearCache">Clear Cache</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.2/ClearCache" modelAttribute="params">
