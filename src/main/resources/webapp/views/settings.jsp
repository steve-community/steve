...
<tr><td><i>The time interval in <b>minutes</b> for how often a charge point <br> should request the current time from SteVe.</i></td><td>(Current value: ${settingsForm.heartbeat})</td></tr>
<tr><td>Expiration:</td><td>
    <form:input path="expiration"/>
    <form:errors path="expiration" cssClass="error"/>
</td></tr>
<tr><td><i>The amount of time in <b>hours</b> for how long a charge point <br> should store the authorization info of an idTag in its local white list.</i></td><td>(Current value: ${settingsForm.expiration})</td></tr>
