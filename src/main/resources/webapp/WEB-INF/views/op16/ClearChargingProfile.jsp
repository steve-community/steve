...
<form:form action="${ctxPath}/manager/operations/v1.6/ClearChargingProfile" modelAttribute="params">
    ...
    <table class="userInput">
		<tr><td>Charging Profile ID (integer):</td><td><form:input path="id" placeholder="optional, 0 = charge point as a whole" /></td></tr>
		<tr><td>Connector ID (integer):</td><td><form:input path="connectorId" placeholder="optional" /></td></tr>
		<tr>
		...
		<tr><td>Stack Level (integer):</td><td><form:input path="stackLevel" placeholder="optional" /></td></tr>
    </table>
