 ...
 * 2023-02-25T02:57:52.064Z
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "CentralSystemService",
                  wsdlLocation = "file:/home/jitpack/build/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl",
...
public class CentralSystemService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/jitpack/build/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CentralSystemService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/jitpack/build/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
