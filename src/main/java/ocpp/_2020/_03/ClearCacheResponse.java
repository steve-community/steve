...
public class ClearCacheResponse implements ResponseType
{
    ...
    public ClearCacheResponse withStatus(ClearCacheStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClearCacheResponse) == false) {
            return false;
        }
        ClearCacheResponse rhs = ((ClearCacheResponse) other);
