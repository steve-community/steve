...
public class CertificateSignedResponse implements ResponseType
{
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("Returns whether certificate signing has been accepted, otherwise rejected.\r\n")
    @NotNull
    ...
    public CertificateSignedResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public CertificateSignedResponse withStatus(CertificateSignedStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CertificateSignedResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CertificateSignedResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CertificateSignedResponse) == false) {
            return false;
        }
        CertificateSignedResponse rhs = ((CertificateSignedResponse) other);
