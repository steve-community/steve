...
public class SetNetworkProfileResponse implements ResponseType
{
    ...
    public SetNetworkProfileResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public SetNetworkProfileResponse withStatus(SetNetworkProfileStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public SetNetworkProfileResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SetNetworkProfileResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SetNetworkProfileResponse) == false) {
            return false;
        }
        SetNetworkProfileResponse rhs = ((SetNetworkProfileResponse) other);
