...
public class UnlockConnectorResponseHandler implements AsyncHandler<UnlockConnectorResponse> {
    private final RequestTask requestTask;
    private final String chargeBoxId;

    @Override
    public void handleResponse(Response<UnlockConnectorResponse> res) {
        try {
