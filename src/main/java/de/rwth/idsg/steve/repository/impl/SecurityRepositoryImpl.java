...
import static jooq.steve.db.tables.FirmwareUpdate.FIRMWARE_UPDATE;
import static jooq.steve.db.tables.LogFile.LOG_FILE;
import static jooq.steve.db.tables.SecurityEvent.SECURITY_EVENT;
...
public class SecurityRepositoryImpl implements SecurityRepository {
    ...
    @Override
    public void insertSecurityEvent(String chargeBoxId, String eventType, DateTime timestamp,
                                     String techInfo, String severity) {
        ...
        ctx.insertInto(SECURITY_EVENT)
           .set(SECURITY_EVENT.CHARGE_BOX_PK, chargeBoxPk)
           .set(SECURITY_EVENT.EVENT_TYPE, eventType)
           .set(SECURITY_EVENT.EVENT_TIMESTAMP, timestamp)
           .set(SECURITY_EVENT.TECH_INFO, techInfo)
           .set(SECURITY_EVENT.SEVERITY, severity)
           .execute();
    ...
    public int insertCertificate(String chargeBoxId, String certificateType, String certificateData,
        ...
        int certificateId = ctx.insertInto(CERTIFICATE)
    ...
    public int insertLogFile(String chargeBoxId, String logType, Integer requestId, String filePath) {
        ...
        int logFileId = ctx.insertInto(LOG_FILE)
    ...
    public int insertFirmwareUpdate(String chargeBoxId, String firmwareLocation, String firmwareSignature,
        ...
        int firmwareUpdateId = ctx.insertInto(FIRMWARE_UPDATE)
    ...
    private Integer getChargeBoxPk(String chargeBoxId) {
        Record1<Integer> record = ctx.select(CHARGE_BOX.CHARGE_BOX_PK)
                                     .from(CHARGE_BOX)
