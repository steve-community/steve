 ...
 * 2024-09-28T11:14:45.110+02:00
 * Generated source version: 4.0.5
 *
 */
@WebServiceClient(name = "CentralSystemService",
                  wsdlLocation = "file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl",
                  targetNamespace = "urn://Ocpp/Cs/2012/06/")
public class CentralSystemService_Service extends Service {

    public static final URL WSDL_LOCATION;

    public static final QName SERVICE = new QName("urn://Ocpp/Cs/2012/06/", "CentralSystemService");
    public static final QName CentralSystemServiceSoap12 = new QName("urn://Ocpp/Cs/2012/06/", "CentralSystemServiceSoap12");
    static {
        URL url = null;
        try {
            url = URI.create("file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CentralSystemService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_centralsystemservice_1.5_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
