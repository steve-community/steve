...
public interface OcppChargingProfileRepository extends CrudRepository<OcppChargingProfile, Integer> {
    ...
    List<OcppChargingProfile> search(Integer chargingProfilePk, Integer stackLevel, String description, String profilePurpose, String profileKind, String recurrencyKind, LocalDateTime validFrom, LocalDateTime validTo);
