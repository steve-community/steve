 ...
 * 2023-02-25T02:57:51.924Z
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "ChargePointService",
                  wsdlLocation = "file:/home/jitpack/build/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl",
...
public class ChargePointService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/jitpack/build/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ChargePointService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/jitpack/build/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
