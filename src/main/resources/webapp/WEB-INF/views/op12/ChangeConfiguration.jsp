...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.2/ChangeConfiguration">Change Configuration</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.2/ChangeConfiguration" modelAttribute="params">
