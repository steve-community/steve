...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/SendLocalList">Send Local List</a></li>
	<hr>
...
<form:form action="${ctxPath}/manager/operations/v1.6/SendLocalList" modelAttribute="params">
