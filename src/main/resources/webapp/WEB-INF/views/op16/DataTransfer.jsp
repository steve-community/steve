...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/DataTransfer">Data Transfer</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/DataTransfer" modelAttribute="params">
