...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/RemoteStopTransaction">Remote Stop Transaction</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/RemoteStopTransaction" modelAttribute="params">
