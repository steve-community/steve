...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/${opVersion}/ChangeConfiguration">Change Configuration</a></li>
...
<div class="op15-content">
    <%@ include file="../op-forms/ChangeConfigurationForm.jsp" %>
</div></div>
