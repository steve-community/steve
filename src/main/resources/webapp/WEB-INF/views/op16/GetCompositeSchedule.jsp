...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/GetCompositeSchedule">Get Composite Schedule</a></li>
	<li><a href="${ctxPath}/manager/operations/v1.6/TriggerMessage">Trigger Message</a></li>
</ul>
</div>
<div class="op16-content">
<form:form action="${ctxPath}/manager/operations/v1.6/GetCompositeSchedule" modelAttribute="params">
    ...
    <table class="userInput">
		...
		<tr><td>Duration (integer):</td><td><form:input path="duration" placeholder="required" /></td></tr>
		<tr>
