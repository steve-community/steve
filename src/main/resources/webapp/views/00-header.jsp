...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/steve/static/css/jquery-ui-1.10.4.custom.min.css" >
    <script type="text/javascript" src="/steve/static/js/jquery-2.0.3.min.js" ></script>
    <script type="text/javascript" src="/steve/static/js/jquery-ui-1.10.4.custom.min.js" ></script>
