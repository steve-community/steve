...
public class ResetResponse implements ResponseType
{
    ...
    public ResetResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public ResetResponse withStatus(ResetStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ResetResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
