...
public class SendLocalListResponse implements ResponseType
{
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("This indicates whether the Charging Station has successfully received and applied the update of the Local Authorization List.\r\n")
    @NotNull
    ...
    public SendLocalListResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public SendLocalListResponse withStatus(SendLocalListStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public SendLocalListResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SendLocalListResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SendLocalListResponse) == false) {
            return false;
        }
        SendLocalListResponse rhs = ((SendLocalListResponse) other);
