...
public class TransactionStopServiceHelper {
    ...
    public static boolean isEnergyValue(TransactionDetails.MeterValues v) {
        ...
        // from 1.6 docs: "To retain backward compatibility, the default values of all of the optional
        // fields on a
        // sampledValue element are such that a value without any additional fields will be interpreted,
        // as a register
        ...
        // if the format is "SignedData", we cannot make any sense of this entry. we don't know how to
        // decode it.
