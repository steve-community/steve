...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.2/RemoteStartTransaction">Remote Start Transaction</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.2/RemoteStartTransaction" modelAttribute="params">
