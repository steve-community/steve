...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/GetLocalListVersion">Get Local List Version</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/GetLocalListVersion" modelAttribute="params">
