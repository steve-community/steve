...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctxPath}/static/css/style.css" charset="utf-8" />
	<title>SteVe - Steckdosenverwaltung</title>
</head>
<body>
<div class="main">
<div class="top-banner"><div class="container"><a href="${ctxPath}/manager/home"><img src="${ctxPath}/static/images/logo2.png" alt="Steve-Logo" height="80"></a></div></div>
