...
public enum UserNotificationFeature {
    ...
    // Ocpp related
    //
    //OcppStationBooted(" a charging station sends a boot notification (Note: This activates notifications "
    //        + "about failed connection attempts for unregistered JSON stations, as well)"),
