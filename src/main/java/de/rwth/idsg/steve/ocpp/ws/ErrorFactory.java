...
/**
 * Error generation should be handled by a central component for better control over the codes and
 * messages. This class just does that.
 *
...
public final class ErrorFactory {
    ...
    public static OcppJsonError payloadSerializeError(String messageId, String details) {
        return setFields(
                ...
                "The payload for action could not be serialized",
                details);
    }
    ...
    private static OcppJsonError setFields(
            String messageId, ErrorCode code, String desc, String details) {
