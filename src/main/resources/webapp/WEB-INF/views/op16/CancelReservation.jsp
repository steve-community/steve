...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/CancelReservation">Cancel Reservation</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/CancelReservation" modelAttribute="params">
