...
<jsp:param name="menuItem" value="CertificateSigned" />
</div>
...
<strong>OCPP v2.0 Certificate Signed</strong>
</span></section>
...
<form:form action="${ctxPath}/manager/operations/v2.0/CertificateSigned" modelAttribute="params">
    <section><span>
        ...
        <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
            <span>Send a signed certificate chain to the selected charge point(s)</span>
        </a>
    </span></section>
    ...
    <table class="userInput">
        ...
        <tr>
            ...
            <td><form:textarea path="certificateChain" cssClass="text" rows="10" /></td>
        </tr>
        <tr>
            <td></td>
            <td id="add_space">
