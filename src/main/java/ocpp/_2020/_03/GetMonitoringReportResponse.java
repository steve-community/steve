...
public class GetMonitoringReportResponse implements ResponseType
{
    ...
    public GetMonitoringReportResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public GetMonitoringReportResponse withStatus(GenericDeviceModelStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GetMonitoringReportResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GetMonitoringReportResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetMonitoringReportResponse) == false) {
            return false;
        }
        GetMonitoringReportResponse rhs = ((GetMonitoringReportResponse) other);
