...
@Slf4j
@Component
public class Ocpp16CallHandler extends AbstractCallHandler
{
    ...
    protected ResponseType dispatch(RequestType params, String chargeBoxId)
    {
        ...
        if (params instanceof BootNotificationRequest) {
            r = service.bootNotification((BootNotificationRequest) params, chargeBoxId, OcppProtocol.V_16_JSON);
