...
import de.rwth.idsg.steve.ocpp.ws.data.security.CertificateSignedRequest;
import de.rwth.idsg.steve.ocpp.ws.data.security.CertificateSignedResponse;
...
public class CertificateSignedTask extends Ocpp16AndAboveTask<CertificateSignedParams, String> {
    ...
    public AsyncHandler<CertificateSignedResponse> getOcpp16Handler(String chargeBoxId) {
        return res -> {
            try {
                CertificateSignedResponse response = res.get();
