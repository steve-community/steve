...
public class CustomerInformationResponse implements ResponseType
{
    ...
    public CustomerInformationResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public CustomerInformationResponse withStatus(CustomerInformationStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CustomerInformationResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CustomerInformationResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CustomerInformationResponse) == false) {
            return false;
        }
        CustomerInformationResponse rhs = ((CustomerInformationResponse) other);
