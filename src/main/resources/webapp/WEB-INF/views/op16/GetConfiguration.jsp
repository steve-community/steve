...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/GetConfiguration">Get Configuration</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/GetConfiguration" modelAttribute="params">
