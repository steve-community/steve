...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.5/ClearCache">Clear Cache</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.5/ClearCache" modelAttribute="params">
