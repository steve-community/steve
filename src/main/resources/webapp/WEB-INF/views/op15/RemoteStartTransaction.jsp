...
<ul>
	...
	<li><a class="highlight" href="/steve/manager/operations/v1.5/RemoteStartTransaction">Remote Start Transaction</a></li>
...
<form:form action="/steve/manager/operations/v1.5/RemoteStartTransaction" modelAttribute="params">
