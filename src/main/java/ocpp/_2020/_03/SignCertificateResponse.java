...
public class SignCertificateResponse implements ResponseType
{
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("Specifies whether the CSMS can process the request.\r\n")
    @NotNull
    ...
    public SignCertificateResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public SignCertificateResponse withStatus(GenericStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public SignCertificateResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SignCertificateResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SignCertificateResponse) == false) {
            return false;
        }
        SignCertificateResponse rhs = ((SignCertificateResponse) other);
