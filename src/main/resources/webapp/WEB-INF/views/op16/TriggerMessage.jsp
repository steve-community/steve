...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/TriggerMessage">Trigger Message</a></li>
</ul>
</div>
<div class="op16-content">
<form:form action="${ctxPath}/manager/operations/v1.6/TriggerMessage" modelAttribute="params">
