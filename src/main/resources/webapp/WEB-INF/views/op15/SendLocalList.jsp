...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.5/SendLocalList">Send Local List</a></li>
</ul>
</div>
<div class="op15-content">
<form:form action="${ctxPath}/manager/operations/v1.5/SendLocalList" modelAttribute="params">
