...
public class ClearChargingProfileParams extends MultipleChargePointSelect {
    ...
    @NotNull(message = "Filter Type is required") private ClearChargingProfileFilterType filterType =
            ClearChargingProfileFilterType.ChargingProfileId;
    ...
    public boolean isValidWhenFilterById() {
        return filterType != ClearChargingProfileFilterType.ChargingProfileId
