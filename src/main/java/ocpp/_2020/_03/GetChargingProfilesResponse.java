...
public class GetChargingProfilesResponse implements ResponseType
{
    ...
    public GetChargingProfilesResponse withStatus(GetChargingProfileStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetChargingProfilesResponse) == false) {
            return false;
        }
        GetChargingProfilesResponse rhs = ((GetChargingProfilesResponse) other);
