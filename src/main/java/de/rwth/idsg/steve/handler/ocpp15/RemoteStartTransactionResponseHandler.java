...
public class RemoteStartTransactionResponseHandler implements AsyncHandler<RemoteStartTransactionResponse> {
    private final RequestTask requestTask;
    private final String chargeBoxId;

    @Override
    public void handleResponse(Response<RemoteStartTransactionResponse> res) {
        try {
