...
<ul>
	...
	<hr>
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.5/ReserveNow">Reserve Now</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.5/ReserveNow" modelAttribute="params">
