...
public class UpdateFirmwareResponse implements ResponseType
{
    ...
    public UpdateFirmwareResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public UpdateFirmwareResponse withStatus(UpdateFirmwareStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateFirmwareResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
