...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/ChangeConfiguration">Change Configuration</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/ChangeConfiguration" modelAttribute="params">
        ...
        <tr>
            ...
            <td>
                <form:select path="confKey">
                    <form:options items="${ocpp16ConfKeys}" />
                </form:select>
            </td>
        </tr>
        <tr>
