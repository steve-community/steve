...
<div class="left-menu">
<ul>
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/ChangeAvailability">Change Availability</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/ChangeAvailability" modelAttribute="params">
