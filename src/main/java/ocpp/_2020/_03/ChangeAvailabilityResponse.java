...
public class ChangeAvailabilityResponse implements ResponseType
{
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("This indicates whether the Charging Station is able to perform the availability change.\r\n")
    @NotNull
    ...
    public ChangeAvailabilityResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public ChangeAvailabilityResponse withStatus(ChangeAvailabilityStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ChangeAvailabilityResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
