 ...
 * 2024-09-28T11:14:45.431+02:00
 * Generated source version: 4.0.5
 *
 */
@WebServiceClient(name = "ChargePointService",
                  wsdlLocation = "file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl",
                  targetNamespace = "urn://Ocpp/Cp/2012/06/")
public class ChargePointService_Service extends Service {

    public static final URL WSDL_LOCATION;

    public static final QName SERVICE = new QName("urn://Ocpp/Cp/2012/06/", "ChargePointService");
    public static final QName ChargePointServiceSoap12 = new QName("urn://Ocpp/Cp/2012/06/", "ChargePointServiceSoap12");
    static {
        URL url = null;
        try {
            url = URI.create("file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ChargePointService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/projects/parkl/ocpp-jaxb/src/main/resources/wsdl/ocpp_chargepointservice_1.5_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
