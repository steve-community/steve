...
/**
 * OCPP 1.6 JSON certification security testcase TC_086_CSMS.
 */
@Slf4j
@ActiveProfiles(profiles = {"test", "test-TC_086_CSMS"})
@SpringBootTest(webEnvironment = WebEnvironment.DEFINED_PORT)
public class Ocpp16JsonCsmsCertification_TC_086_CSMS_IT extends AbstractOcpp16JsonCsms {
