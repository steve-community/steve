...
<ul>
	...
	<hr>
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/ReserveNow">Reserve Now</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/ReserveNow" modelAttribute="params">
