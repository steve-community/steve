...
public class TriggerMessageResponse implements ResponseType
{
    ...
    public TriggerMessageResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public TriggerMessageResponse withStatus(TriggerMessageStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public TriggerMessageResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
