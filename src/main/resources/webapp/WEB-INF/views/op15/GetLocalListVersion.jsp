...
<ul>
	...
	<li><a class="highlight" href="/steve/manager/operations/v1.5/GetLocalListVersion">Get Local List Version</a></li>
	<li><a href="/steve/manager/operations/v1.5/SendLocalList">Send Local List</a></li>
</ul>
</div>
<div class="op15-content">
<form:form action="/steve/manager/operations/v1.5/GetLocalListVersion" modelAttribute="params">
