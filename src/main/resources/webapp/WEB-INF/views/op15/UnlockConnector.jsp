...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.5/UnlockConnector">Unlock Connector</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.5/UnlockConnector" modelAttribute="params">
