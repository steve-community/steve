...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.6/RemoteStartTransaction">Remote Start Transaction</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.6/RemoteStartTransaction" modelAttribute="params">
