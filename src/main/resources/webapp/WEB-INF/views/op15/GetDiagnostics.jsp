...
<ul>
	...
	<li><a class="highlight" href="${ctxPath}/manager/operations/v1.5/GetDiagnostics">Get Diagnostics</a></li>
...
<form:form action="${ctxPath}/manager/operations/v1.5/GetDiagnostics" modelAttribute="params">
